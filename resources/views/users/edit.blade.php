                        ...
                        <div class="pt-8 border-t border-gray-50 dark:border-slate-800">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <div class="relative" x-data="{ show: false }">
                                        <input id="password" x-bind:type="show ? 'text' : 'password'" name="password" 
                                            class="block w-full rounded-2xl border-gray-100 dark:border-slate-700 bg-gray-50/50 dark:bg-slate-800/50 py-3 pl-4 pr-12 focus:ring-4 focus:ring-brand-teal/10 focus:border-brand-teal transition-all duration-300 font-medium text-brand-navy dark:text-gray-100 placeholder-gray-300 dark:placeholder-gray-600"
                                ...
                                <div>
                                    ...
                                    <div class="relative" x-data="{ show: false }">
                                        <input id="password_confirmation" x-bind:type="show ? 'text' : 'password'" name="password_confirmation" 
                                            class="block w-full rounded-2xl border-gray-100 dark:border-slate-700 bg-gray-50/50 dark:bg-slate-800/50 py-3 pl-4 pr-12 focus:ring-4 focus:ring-brand-teal/10 focus:border-brand-teal transition-all duration-300 font-medium text-brand-navy dark:text-gray-100 placeholder-gray-300 dark:placeholder-gray-600"
