<x-app-layout>
    @section('title', 'Create Assessment Test | ' . config('app.name'))
    <x-slot name="header">
                ...
                <nav class="flex mb-3" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-2 text-[10px] font-bold uppercase tracking-widest">
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="text-brand-teal dark:text-brand-accent">New Test</span>
                        </li>
                    </ol>
                </nav>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    {{ __('Create Assessment Test') }}
                </h2>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl transition-all duration-300 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden border border-slate-100 dark:border-slate-800 ring-1 ring-slate-900/5 dark:ring-white/10">
                <form action="{{ route('tests.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                    @csrf
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="group">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g. AI Design Task" 
                            ...
                            <div class="group">
                                ...
                                <input type="text" name="subject" id="subject" value="{{ old('subject') }}" placeholder="Subject candidates will see" 
